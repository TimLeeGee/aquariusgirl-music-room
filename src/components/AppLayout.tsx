...
export function AppLayout({
  ...
  return (
    <div
      className="relative z-10 min-h-screen overflow-hidden px-4 pb-32 pt-4 text-white sm:px-6 lg:px-8"
      {...dragHandlers}
    >
      {audio}
      {dropZone}
      {toast}
      <div className="mx-auto flex min-h-[calc(100vh-8rem)] w-full max-w-7xl flex-col gap-5">
        {header}
