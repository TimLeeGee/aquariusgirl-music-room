...
1. 執行 `Aquariusgirl Music Room Setup 0.1.17.exe`。
2. 選擇安裝位置。
...
1. 開啟 `Aquariusgirl Music Room-0.1.17-arm64.dmg`。
...
1. Run `Aquariusgirl Music Room Setup 0.1.17.exe`.
...
1. Open `Aquariusgirl Music Room-0.1.17-arm64.dmg`.
